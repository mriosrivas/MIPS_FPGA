...
module m14k_mpc_ctl(
	...
	output 	    cond_not_met_e;     // SELEQZ/SELNEZ
...
//	assign kill_cmov_e = mpc_cmov_e & (edp_cndeq_e ^ cmov_type_e) |		// SELEQZ/SELNEZ
//			mpc_movci_e & ~cp1_btaken;									// SELEQZ/SELNEZ
	assign kill_cmov_e = //mpc_cmov_e & (edp_cndeq_e ^ cmov_type_e) |	// SELEQZ/SELNEZ
			mpc_movci_e & ~cp1_btaken;									// SELEQZ/SELNEZ
	assign cond_not_met_e = mpc_cmov_e & (edp_cndeq_e ^ cmov_type_e);	// SELEQZ/SELNEZ
