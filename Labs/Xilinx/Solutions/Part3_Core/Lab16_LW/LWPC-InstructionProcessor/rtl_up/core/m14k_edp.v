...
//        assign aop_e [31:0] = icc_pcrel_e ? (iva_e & ~{30'b0, {2{icc_pcrel_e}}}) :  edp_abus_e;
        assign aop_e [31:0] = lwpc_instr ? iva_e : (icc_pcrel_e ? (iva_e & ~{30'b0, {2{icc_pcrel_e}}}) :  edp_abus_e); // LWPC
	...
	wire 		car31_e;
 	...
 	assign dva_offset_e[31:0] = lwpc_instr ? {{11{mpc_ir_e[18]}}, mpc_ir_e[18:0], 2'b0} : (!mpc_selimm_e ? bbusis_e 
		: (mpc_atomic_e || mpc_atomic_m) ? {{20{mpc_imsgn_e}}, mpc_ir_e[11:0]} 
		: {{16{mpc_imsgn_e}}, mpc_ir_e[15:0]});											// LWPC
