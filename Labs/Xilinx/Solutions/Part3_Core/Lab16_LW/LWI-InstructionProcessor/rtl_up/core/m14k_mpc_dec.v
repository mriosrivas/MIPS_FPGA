...
//	assign mpc_ldst_e =	mpc_lxs_e || mpc_ir_e[31] || (regimm_e && (mpc_ir_e[20:16] == 5'o07))
	assign mpc_ldst_e =	lwi_instr_e || mpc_lxs_e || mpc_ir_e[31] || (regimm_e && (mpc_ir_e[20:16] == 5'o07))	// LWI
	...
	// New signals for supporting new instruction LWI
