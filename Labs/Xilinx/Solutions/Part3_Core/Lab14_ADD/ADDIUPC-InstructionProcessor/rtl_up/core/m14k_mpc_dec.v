...
//		 ((mpc_ir_e[31:26] == 6'b011_000) && (mpc_ir_e[20:19] != 2'b00)) ||	// ADDIUPC
...
//		 ((mpc_ir_e[31:26] == 6'o73) && (mpc_ir_e[20:19] != 2'b00));		// ADDIUPC
...
//		  ((mpc_ir_e[31:26] == 6'o30) && (mpc_ir_e[20:19] == 2'b00)) ||						// ADDIUPC
	...
	assign dest_cnvt_dsp_e = spec3_e &
        ...
        assign dest_e [5:0] = addiupc_instr ? { 1'b0, mpc_ir_e[25:21] } : ((special_e | spec2_e | mpc_cnvt_e | rwpgpr_e | dest_cnvt_dsp_e | lx_e) ? { rwpgpr_e & ~rdpgpr_e, pdest_e } : 
		                    				       ((lnk31_e) ? 6'h1f :
										    { 1'b0, src_b_e[4:0] }));  // ADDIUPC
	...
	// New signal for supporting new instruction ADDIUPC
//	assign addiupc_instr = (mpc_ir_e[31:26] == 6'o30) && (mpc_ir_e[20:19] == 2'b00);	// ADDIUPC
	assign addiupc_instr = (mpc_ir_e[31:26] == 6'o30) ;									// ADDIUPC
