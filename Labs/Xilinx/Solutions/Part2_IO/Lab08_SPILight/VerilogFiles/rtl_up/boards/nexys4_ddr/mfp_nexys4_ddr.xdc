...
set_input_delay -clock "clk_virt" -min -add_delay 0.000 [get_ports JA[3]]
set_input_delay -clock "clk_virt" -max -add_delay 20.000 [get_ports JA[3]]
...
set_output_delay -clock "clk_virt" -max -add_delay 20.000 [get_ports {JC[*]}]

set_output_delay -clock "clk_virt" -min -add_delay 0.000 [get_ports {JA[1]}]
set_output_delay -clock "clk_virt" -max -add_delay 20.000 [get_ports {JA[1]}]
set_output_delay -clock "clk_virt" -min -add_delay 0.000 [get_ports {JA[4]}]
set_output_delay -clock "clk_virt" -max -add_delay 20.000 [get_ports {JA[4]}]
