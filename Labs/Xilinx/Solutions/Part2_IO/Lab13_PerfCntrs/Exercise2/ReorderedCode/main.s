...
.LBE2 = .
 ...
 #APP
 # 51 "main.c" 1
	.set noreorder;LUI 	$t0, 0x8000;ADDIU 	$t0, $t0, V;SUB $t1,$t1,$t1;SUB $t3,$t3,$t3;ADDI $t4,$0,1000;Loop1:	BEQ $t3,$t4,OutLoop1;ADDI $t3,$t3,1;LW $t5,0($t0);ADDI $t0,$t0,4;B Loop1;ADD $t1,$t1,$t5;OutLoop1: LUI   $t3, 0x8000;ADDIU  $t3, $t3, Addition;SW $t1,0($t3);.set reorder;
 # 0 "" 2
 #NO_APP
.LBB3 = .
.LBB4 = .
...
.LASF22:
	.ascii	"C:\\Users\\Dani\\Desktop\\SimulationSources_Exercise2_Re"
	.ascii	"ordered\000"
.LASF8:
	.ascii	"reg32_t\000"
.LASF11:
