...
.Ltext0:
	...
	.comm	test_arrayA,400,4

	.comm	test_arrayB,400,4

	.comm	test_arrayResult,400,4
	.rdata
	.align	2
.LC0:
	.ascii	"\012Result[0]=%d, Result[50]=%d, Result[99]=%d\012\000"
	.text
	.align	2
	.globl	main
.LFB0 = .
...
.L3:
	...
	lui	$2,%hi(test_arrayA)
	lw	$3,16($fp)
	sll	$3,$3,2
	addiu	$2,$2,%lo(test_arrayA)
	addu	$2,$3,$2
	lw	$3,16($fp)
	sw	$3,0($2)
	lw	$2,16($fp)
...
.L5:
	...
	lw	$2,16($fp)
	mult	$3,$2
	lui	$2,%hi(test_arrayB)
	lw	$3,16($fp)
	sll	$3,$3,2
	addiu	$2,$2,%lo(test_arrayB)
	addu	$2,$3,$2
	mflo	$3
	sw	$3,0($2)
	lw	$2,16($fp)
...
.L7:
	...
	lui	$2,%hi(test_arrayResult)
	lw	$3,16($fp)
	sll	$3,$3,2
	addiu	$2,$2,%lo(test_arrayResult)
	addu	$2,$3,$2
	sw	$0,0($2)
	lw	$2,16($fp)
	addiu	$2,$2,1
...
.LBE2 = .
 ...
 #APP
 # 53 "main.c" 1
	.set noreorder;   addi    $t1,$0,100;   lui 	$t6, 0x8000;   addiu 	$t6, $t6, test_arrayA;   lui 	$t7, 0x8000;   addiu 	$t7, $t7, test_arrayB;   lui 	$t8, 0x8000;   addiu 	$t8, $t8, test_arrayResult;LOOP:  LW      $t2,0($t6);       ADDI    $t6,$t6,4;		ADD 	$t2,$t2,$t2;       LW      $t3,0($t7);       ADDI    $t7,$t7,4;		ADD 	$t3,$t2,$t3;		BEQ		$t3,$0, NoAct;       ADDI    $t1,$t1,-1;       SW      $t3,0($t8);NoAct: BNE     $t1,$0,LOOP;       ADDI    $t8,$t8,4;.set reorder;
 # 0 "" 2
 #NO_APP
.LBB3 = .
.LBB4 = .
...
.LASF14:
	.ascii	"allDigits\000"
.LASF19:
	.ascii	"test_arrayA\000"
.LASF20:
	.ascii	"test_arrayB\000"
.LASF16:
	.ascii	"_mips_handle_exception\000"
.LASF24:
	.ascii	"C:\\Users\\Dani\\Desktop\\SimulationSources_Exercise4_Re"
	.ascii	"orderedCode\000"
.LASF21:
	.ascii	"test_arrayResult\000"
.LASF3:
