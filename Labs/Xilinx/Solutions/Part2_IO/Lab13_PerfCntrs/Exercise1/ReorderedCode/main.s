...
.LBE2 = .
 ...
 #APP
 # 45 "main.c" 1
	   .set noreorder;   add $s0, $0, $0;   add $s1, $0, $0;   addi $t0, $0, 1000;   loop:   slt $t1, $s0, $t0;   beq $t1, $0, done;   add $s1, $s1, $s0;   j loop;   addi $s0, $s0, 1;   done:   sub $s1, $s1, $s0;   .set reorder;
 # 0 "" 2
 #NO_APP
.LBB3 = .
.LBB4 = .
...
.LASF17:
	.ascii	"C:\\Users\\Dani\\Desktop\\ReorderedCode\000"
.LASF10:
	.ascii	"digit\000"
.LASF7:
