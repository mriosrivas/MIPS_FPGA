...
.LBE2 = .
 ...
 #APP
 # 49 "main.c" 1
	   lui 	$t6, 0x8000;   addiu 	$t6, $t6, test_array;	addi   	$t1,$0,100;LOOP:  LW      $t2,0($t6);       LW      $t3,400($t6);       SUB     $t2,$t3,$t2;       SW      $t2,800($t6);       ADDI    $t1,$t1,-1;       ADDI    $t6,$t6,4;       BNE     $t1,$0,LOOP;   addi    $t1,$t1,100;
 # 0 "" 2
 #NO_APP
.LBB3 = .
.LBB4 = .
...
.LASF21:
	.ascii	"C:\\Users\\Dani\\Desktop\\Exercise3_Original\000"
.LASF3:
