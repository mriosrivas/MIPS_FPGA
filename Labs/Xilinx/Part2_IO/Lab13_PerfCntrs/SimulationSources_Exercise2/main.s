...
.Ltext0:
	...
	.comm	test_array,4000,4

	.comm	Addition,4,4
	.rdata
	.align	2
.LC0:
	.ascii	"\012Addition=%d\012\000"
	.text
	.align	2
	.globl	main
.LFB0 = .
...
.LBE2 = .
 ...
 #APP
 # 51 "main.c" 1
	LUI 	$t0, 0x8000;ADDIU 	$t0, $t0, test_array;SUB $t1,$t1,$t1;SUB $t3,$t3,$t3;ADDI $t4,$0,1000;Loop1:	BEQ $t3,$t4,OutLoop1;LW $t5,0($t0);ADD $t1,$t1,$t5;ADDI $t0,$t0,4;ADDI $t3,$t3,1;B Loop1;OutLoop1: LUI   $t3, 0x8000;ADDIU  $t3, $t3, Addition;SW $t1,0($t3);
 # 0 "" 2
 #NO_APP
.LBB3 = .
.LBB4 = .
...
.LASF5:
	.ascii	"short int\000"
.LASF23:
	.ascii	"C:\\Users\\Dani\\Desktop\\SimulationSources_Exercise2\000"
.LASF6:
	.ascii	"event1\000"
.LASF7:
	.ascii	"event2\000"
