...
.LBE2 = .
 ...
 #APP
 # 53 "main.c" 1
	   addi    $t1,$0,100;   lui 	$t6, 0x8000;   addiu 	$t6, $t6, test_arrayA;   lui 	$t7, 0x8000;   addiu 	$t7, $t7, test_arrayB;   lui 	$t8, 0x8000;   addiu 	$t8, $t8, test_arrayResult;LOOP:  LW      $t2,0($t6);		ADD 	$t2,$t2,$t2;       LW      $t3,0($t7);		ADD 	$t3,$t2,$t3;		BEQ		$t3,$0, NoAct;       SW      $t3,0($t8);NoAct: ADDI    $t6,$t6,4;       ADDI    $t7,$t7,4;       ADDI    $t8,$t8,4;       ADDI    $t1,$t1,-1;       BNE     $t1,$0,LOOP;
 # 0 "" 2
 #NO_APP
.LBB3 = .
.LBB4 = .
...
.LASF5:
	.ascii	"short int\000"
.LASF24:
	.ascii	"C:\\Users\\Dani\\Desktop\\SimulationSources_Exercise4\000"
.LASF6:
	.ascii	"event1\000"
.LASF7:
	.ascii	"event2\000"
