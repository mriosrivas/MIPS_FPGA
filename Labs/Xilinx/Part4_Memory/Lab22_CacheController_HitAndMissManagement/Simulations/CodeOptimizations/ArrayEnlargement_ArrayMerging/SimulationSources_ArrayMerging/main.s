...
.LBE2 = .
 ...
 #APP
 # 76 "main.c" 1
	   li $t1, 512;   li $t2, 0;   li $t9, 0;   lui $t4, 0x8000;   addiu $t4, $t4, array;   loop2:   lw  $t7, 0($t4);   addiu $t4, $t4, 4;   nop;   nop;   nop;   lw  $t8, 0($t4);   addiu $t4, $t4, 4;   nop;   nop;   nop;   add $t6, $t7, $t8;   add $t9, $t9, $t6;   nop;   addiu $t2, $t2, 1;   blt $t2, $t1, loop2;   add $2, $t9, $zero;
 # 0 "" 2
 #NO_APP
	sw	$2,20($fp)
.LBB3 = .
...
.LASF19:
	.ascii	"C:\\Users\\Dani\\Desktop\\SimulationSources_ArrayMerging"
	.ascii	"\000"
.LASF14:
	.ascii	"reason\000"
.LASF9:
