...
.LBE2 = .
 ...
 #APP
 # 59 "main.c" 1
	   nop;   lui $t4, 0x8000;   addiu $t4, $t4, test_data;   nop;   lw  $t5, 0($t4);   nop;   lw  $t5, 4($t4);   nop;   lw  $t5, 8($t4);   nop;   lw  $t5, 12($t4);   nop;
 # 0 "" 2
 #NO_APP
.LBB3 = .
.LBB4 = .
...
.L20:
	...
	jal	writeValTo7Segs
.LVL19 = .
	.loc 1 110 0 is_stmt 1 discriminator 4
	b	.L9
.L17:
.LBB11 = .
	.loc 1 113 0
...
.LASF15:
	.ascii	"main.c\000"
.LASF16:
	.ascii	"C:\\Users\\Dani\\Desktop\\CacheLineSize\000"
.LASF6:
