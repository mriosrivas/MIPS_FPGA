...
int __attribute__((aligned(16))) test_data[600];
...
int main() {
    ...
    ( 
        ...
        "      nop;"
        "      nop;"
        "      lw  $t5, 2048($t4);" // When using a direct-mapped 2KB D$, the block containing the requested data by this lw maps to the same D$ set as the block containing the data requested by the lw above
        "      addiu $t4, $t4, 4;"
        "      addiu $t2, $t2, 1;"
        "      blt $t2, $t1, loop2;"
    );
