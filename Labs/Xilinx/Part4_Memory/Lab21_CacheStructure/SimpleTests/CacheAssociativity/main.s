...
.LBE2 = .
 ...
 #APP
 # 59 "main.c" 1
	   li $t1, 4;   li $t2, 0;   lui $t4, 0x8000;   addiu $t4, $t4, test_data;   loop2:      lw  $t5, 0($t4);      nop;      nop;      nop;      nop;      nop;      nop;      lw  $t5, 2048($t4);      addiu $t4, $t4, 4;      addiu $t2, $t2, 1;      blt $t2, $t1, loop2;
 # 0 "" 2
 #NO_APP
.LBB3 = .
.LBB4 = .
...
.L21:
	...
	jal	writeValTo7Segs
.LVL14 = .
	.loc 1 100 0 is_stmt 1 discriminator 4
	b	.L9
.L16:
.LBB9 = .
	.loc 1 103 0
...
.LASF5:
	.ascii	"reg32_t\000"
.LASF16:
	.ascii	"C:\\Users\\Dani\\Desktop\\CacheAssociativity\000"
.LASF9:
	.ascii	"enDigits\000"
.LASF14:
