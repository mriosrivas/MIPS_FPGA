...
module d_wsram_2k1way_xilinx(
	...
	input [0:0]	wr_data;	// Data for Tag Write
	input [0:0]	bist_to;

	/* Outputs */
	output [0:0]	rd_data;		// output from read
	...
	assign	rd_data[0:0] = ws_rd_data[0:0];
